...
//	PgxGraph graph = session.readGraphWithProperties("/var/services/homes/yoshen/work/projects/graph-pgx/datasets/soc-LiveJournal1.vid.adj.json");
	...
	CompiledProgram exactDiameter = session.compileProgram("../github/OraclePGX_FinalReport/diameter/exactDiameter.gm");
...
//		long startTime = System.currentTimeMillis();
		AnalysisResult <Integer> result = exactDiameter.run(graph,ID,radius);
