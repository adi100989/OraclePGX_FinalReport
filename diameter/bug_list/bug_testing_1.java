...
//	PgxGraph graph = session.readGraphWithProperties("/var/services/homes/yoshen/work/projects/graph-pgx/datasets/soc-LiveJournal1.vid.adj.json");
	...
	CompiledProgram bug_testing_1 = session.compileProgram("../github/OraclePGX_FinalReport/diameter/bug_testing_1.gm");
...
//		long startTime = System.currentTimeMillis();
		AnalysisResult <Boolean> result = bug_testing_1.run(graph,ID,radius);
