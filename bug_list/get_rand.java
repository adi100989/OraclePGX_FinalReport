...
//	PgxGraph graph = session.readGraphWithProperties("/var/services/homes/yoshen/work/projects/graph-pgx/datasets/soc-LiveJournal1.vid.adj.json");
	...
	CompiledProgram get_rand = session.compileProgram("../github/OraclePGX_FinalReport/diameter/get_rand.gm");
...
//		long startTime = System.currentTimeMillis();
		AnalysisResult <Integer> result = get_rand.run(graph,ID,radius);
