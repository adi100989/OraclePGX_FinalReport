...
//	PgxGraph graph = session.readGraphWithProperties("/var/services/homes/yoshen/work/projects/graph-pgx/datasets/soc-LiveJournal1.vid.adj.json");
	...
	CompiledProgram test_vectors = session.compileProgram("../github/OraclePGX_FinalReport/diameter/bug_list/test_vectors.gm");
...
//		long startTime = System.currentTimeMillis();
		AnalysisResult <Boolean> result = test_vectors.run(graph,ID,radius);
