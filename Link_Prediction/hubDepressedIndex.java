...
public class hubDepressedIndex {

  public static void main(String[] args) throws Exception {
	System.out.println("\n entered Java Program");
    	PgxSession session = Pgx.createSession("my-session");
    	CompiledProgram hubDepressedIndex = session.compileProgram("../github/OraclePGX_FinalReport/Link_Prediction/hubDepressedIndex.gm");
...
//	PgxGraph graph = session.readGraphWithProperties("/var/services/homes/adisingh/code/facebook.json");
	...
	VertexProperty<Integer,Double>  cmn_nbr  = graph.createVertexProperty(PropertyType.DOUBLE, "cmn_nbr");		
  	...
  	AnalysisResult <Integer> result = hubDepressedIndex.run(graph,ID, link_node_ID,cmn_nbr);
