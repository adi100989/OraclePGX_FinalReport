...
public class commonNeighbors3 {

  public static void main(String[] args) throws Exception {
	System.out.println("\n entered Java Program");
    	PgxSession session = Pgx.createSession("my-session");
    	CompiledProgram commonNeighbors3 = session.compileProgram("../github/OraclePGX_FinalReport/Link_Prediction/commonNeighbors3.gm");
...
//	PgxGraph graph = session.readGraphWithProperties("/var/services/homes/adisingh/code/facebook.json");
	...
	VertexProperty<Map<Integer,Integer>>  link_node  = graph.createVertexProperty(PropertyType.VERTEX, "link_node");		
