...
public class commonNeighbors4 {

  public static void main(String[] args) throws Exception {
	System.out.println("\n entered Java Program");
    	PgxSession session = Pgx.createSession("my-session");
    	CompiledProgram commonNeighbors4 = session.compileProgram("../github/OraclePGX_FinalReport/Link_Prediction/exampleVector.gm");
...
//	PgxGraph graph = session.readGraphWithProperties("/var/services/homes/adisingh/code/facebook.json");
    ...
    //	graph=graph.undirect();
 	...
 	VertexProperty<Integer, Boolean> is_left = graph.getVertexProperty()
        ...
        VertexProperty<Integer,PgxVect<Integer>> link_node = graph.createVertexProperty(PropertyType.INTEGER, "link_node");
	...
	//Scalar<PgxVect<Integer>>  link_node  = graph.createVectorScalar(PropertyType.INTEGER,40000,"link_node");		
  	...
  	AnalysisResult <Integer> result = commonNeighbors2.run(graph,ID, link_node);
