...
public class preferentialAttachment {
  ...
  public static void main(String[] args) throws Exception {
	System.out.println("\n entered Java Program");
    	...
    	CompiledProgram preferentialAttachment  = session.compileProgram("../github/OraclePGX_FinalReport/Link_Prediction/preferentialAttachment.gm");
...
//	PgxGraph graph = session.readGraphWithProperties("/var/services/homes/adisingh/code/facebook.json");
	...
	VertexProperty<Integer,Integer>  cmn_nbr  = graph.createVertexProperty(PropertyType.INTEGER, "cmn_nbr");		
  	...
  	AnalysisResult <Integer> result =  preferentialAttachment.run(graph,ID, link_node_ID,cmn_nbr);
